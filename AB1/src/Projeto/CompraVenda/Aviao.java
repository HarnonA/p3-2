...
public class Aviao implements PrototipoAviao {
	...
	public Aviao(int poltronas, int filas, String tipo, String origem,
			String destino, int nSerie) {
	...
	public String toString() {
		...
		// s += nSerie + " ";
		/*
		 * s += "Num Serie: " + nSerie; s += " | Modelo: " + tipo +
		 * " | Assentos: " + colunas * filas + "\nDe " + origem + " para " +
		 * destino + "\n";
		 */
